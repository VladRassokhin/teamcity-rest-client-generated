...
public class AppRestTests {
  private Client _client;
  private UriBuilder _uriBuilder;
  private Map<String, Object> _templateAndMatrixParameterValues;

  AppRestTests(Client client, UriBuilder uriBuilder, Map<String, Object> map) {
    _client = client;
  ...
  public static class TestLocator {
    ...
    public TestLocator(Client client, URI uri) {
      ...
      template = TeamcityJetbrainsCom.getTemplateBuilder("app/rest/tests/{testLocator}");
