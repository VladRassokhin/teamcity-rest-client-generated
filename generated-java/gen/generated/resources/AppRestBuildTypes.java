...
public class AppRestBuildTypes extends AbstractAppRest {
   ...
   */
  public AppRestBuildTypes(Client client, URI baseUri, TeamCityClient tjc) {
    super(tjc);
    _client = client;
  ...
  public class BtLocatorParameters {
    ...
    public Property post(Property input, String fields) {
      ...
      javax.ws.rs.client.Invocation.Builder resourceBuilder = Utils.getBuilder(localUriBuilder, _client, _templateAndMatrixParameterValues, "application/json");Response response = resourceBuilder.build("POST", Entity.entity(new JAXBElement(new QName("", "property"), Property.class, input), "application/json")).invoke();
      Utils.throwExceptionIfWrongStatus(response);
      return response.readEntity(Property.class);
    }
  }
  ...
  public class BtLocatorTemplate {
    ...
    public <T> T putTextPlain(Object input, String fields, Class<T> returnType) {
      ...
      javax.ws.rs.client.Invocation.Builder resourceBuilder = Utils.getBuilder(localUriBuilder, _client, _templateAndMatrixParameterValues, "application/json");Response response = resourceBuilder.build("PUT", Entity.entity(input, "text/plain")).invoke();
      if (!Response.class.isAssignableFrom(returnType)) {
        Utils.throwExceptionIfWrongStatus(response);
      }
      return Utils.getReturnValue(returnType, response);
