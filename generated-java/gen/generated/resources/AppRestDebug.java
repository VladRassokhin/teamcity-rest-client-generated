...
import generated.data.VcsRootInstances;
...
public class AppRestDebug extends AbstractAppRest {
   ...
   */
  public AppRestDebug(Client client, URI baseUri, TeamCityClient tjc) {
    super(tjc);
    _client = client;
  ...
  public class VcsCheckingForChangesQueue {
    ...
    public VcsRootInstances post(String locator) {
      ...
      javax.ws.rs.client.Invocation.Builder resourceBuilder = Utils.getBuilder(localUriBuilder, _client, _templateAndMatrixParameterValues, "application/json");Response response = resourceBuilder.build("POST").invoke();
      Utils.throwExceptionIfWrongStatus(response);
      return response.readEntity(VcsRootInstances.class);
    }
  }
