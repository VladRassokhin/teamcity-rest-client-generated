...
import generated.data.ProblemOccurrence;
import generated.data.ProblemOccurrences;
...
public class AppRestProblemOccurrences extends AbstractAppRest {
   ...
   */
  public AppRestProblemOccurrences(Client client, URI baseUri, TeamCityClient tjc) {
    super(tjc);
    _client = client;
