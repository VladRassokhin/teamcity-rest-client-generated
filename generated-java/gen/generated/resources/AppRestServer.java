...
import generated.data.PluginInfos;
import generated.data.Server;
...
public class AppRestServer extends AbstractAppRest {
   ...
   */
  public AppRestServer(Client client, URI baseUri, TeamCityClient tjc) {
    super(tjc);
    _client = client;
  ...
  public class Backup {
    ...
    public <T> String postAsTextPlain(String filename, Boolean addtimestamp, Boolean includeconfigs, Boolean includedatabase, Boolean includebuildlogs, Boolean includepersonalchanges, Boolean includerunningbuilds, Boolean includesupplimentarydata, Class<T> returnType) {
      ...
      javax.ws.rs.client.Invocation.Builder resourceBuilder = Utils.getBuilder(localUriBuilder, _client, _templateAndMatrixParameterValues, "text/plain");Response response = resourceBuilder.build("POST").invoke();
      if (!Response.class.isAssignableFrom(String.class)) {
        Utils.throwExceptionIfWrongStatus(response);
      }
      return Utils.getStringValue(response);
