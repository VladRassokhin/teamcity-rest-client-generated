...
public class AppRestProblems {
  private Client _client;
  private UriBuilder _uriBuilder;
  private Map<String, Object> _templateAndMatrixParameterValues;

  AppRestProblems(Client client, UriBuilder uriBuilder, Map<String, Object> map) {
    _client = client;
  ...
  public static class ProblemLocator {
    ...
    public ProblemLocator(Client client, URI uri) {
      ...
      template = TeamcityJetbrainsCom.getTemplateBuilder("app/rest/problems/{problemLocator}");
